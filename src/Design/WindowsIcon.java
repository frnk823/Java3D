...
public class WindowsIcon extends Applet
...
//定义第二个Bezier曲面外观属性
    ...
    color2.setColor(0.f,0.f,1.f);
    app2.setColoringAttributes(color2);
    //定义第三个Bezier曲面的16个控制顶点
    float[][][] P3={{{0.8f,0.1f,0.9f,1.f},
            {1.4f,0.1f,0.9f,1.f},
            {1.8f,0.f,-0.8f,1.f},
            {2.4f,0.1f,0.9f,1.f}  },
...
//定义第三个Bezier曲面外观属性
    ...
    color3.setColor(1.f,1.f,0.f);
    app3.setColoringAttributes(color3);

    //定义第四个Bezier曲面的16个控制顶点
    float[][][] P4={{{0.8f,0.8f,-0.5f,1.f} ,
            {1.4f,0.8f,-0.5f,1.f},
            {1.8f,0.9f,-0.4f,1.f},
            {2.4f,0.8f,-0.5f,1.f}  },
...
//定义第四个Bezier曲面外观属性
    ...
    Shape3D BezierControlPoints4=new BezierSurfaceControlPoints(P4,app1);
    ...
    {new MainFrame(new WindowsIcon(),800,800); }
}
class  BezierThreeOrderSurfaceface1 extends Shape3D
{public BezierThreeOrderSurfaceface1(float[][][] P,Appearance app)
{int i,j,k;
...
class  BezierSurfaceControlPoints1 extends Shape3D
{public BezierSurfaceControlPoints1(float[][][] P,Appearance app)
{int i,j,k;
...
{public float CC[][]= new float[4][4];
    int ll,mm,kk;
    public matrixm1(int mmm, int kkk, int nnn,float a[][],float b[][])
    {for(ll=0;ll<mmm;ll++)
