...
//定义第一个Bezier曲面的16个控制顶点
    float[][][] P1={
                 ...
                 {  {-0.8f,0.85f,0.f,1.f},
                    {-0.8f,0.85f,0.15f,1.f},
                    {-0.8f,0.85f,0.35f,1.f},
                    {0.f,0.3f,0.5f,1.f} },
...
//定义第四个Bezier曲面外观属性
    ...
    {new MainFrame(new Heart(),800,800); }
}
